  ...
  return (
    <>
      ...
      <aside className={`${isOpen ? 'w-72' : 'w-0'} transition-all duration-300 bg-surface-900 border-r border-surface-800 flex flex-col overflow-hidden shrink-0`}>
        ...
        <div className="p-4 border-b border-surface-800 shrink-0 space-y-1">
          <button
          ...
          <button
            ...
            className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors flex items-center gap-2 ${
              currentView.type === 'playground' ? 'bg-primary-500/10 text-primary-400' : 'text-surface-400 hover:bg-surface-800 hover:text-surface-200'
            }`}
          >
          ...
          <button
            ...
            className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors flex items-center gap-2 ${
              currentView.type === 'challengeList' || currentView.type === 'challenge' ? 'bg-primary-500/10 text-primary-400' : 'text-surface-400 hover:bg-surface-800 hover:text-surface-200'
            }`}
          >
